...
static_assert(alignof(VATMeshComponent_SetAnimation) == 0x000004, "Wrong alignment on VATMeshComponent_SetAnimation");
static_assert(sizeof(VATMeshComponent_SetAnimation) == 0x000008, "Wrong size on VATMeshComponent_SetAnimation");
static_assert(offsetof(VATMeshComponent_SetAnimation, Index_0) == 0x000000, "Member 'VATMeshComponent_SetAnimation::Index_0' has a wrong offset!");
static_assert(offsetof(VATMeshComponent_SetAnimation, InTimeStartOffset) == 0x000004, "Member 'VATMeshComponent_SetAnimation::InTimeStartOffset' has a wrong offset!");
...
static_assert(alignof(VATMeshComponent_GetAnimation) == 0x000004, "Wrong alignment on VATMeshComponent_GetAnimation");
static_assert(sizeof(VATMeshComponent_GetAnimation) == 0x000010, "Wrong size on VATMeshComponent_GetAnimation");
static_assert(offsetof(VATMeshComponent_GetAnimation, Index_0) == 0x000000, "Member 'VATMeshComponent_GetAnimation::Index_0' has a wrong offset!");
static_assert(offsetof(VATMeshComponent_GetAnimation, ReturnValue) == 0x000004, "Member 'VATMeshComponent_GetAnimation::ReturnValue' has a wrong offset!");
...
static_assert(alignof(VATMeshComponent_GetNumAnimations) == 0x000004, "Wrong alignment on VATMeshComponent_GetNumAnimations");
static_assert(sizeof(VATMeshComponent_GetNumAnimations) == 0x000004, "Wrong size on VATMeshComponent_GetNumAnimations");
static_assert(offsetof(VATMeshComponent_GetNumAnimations, ReturnValue) == 0x000000, "Member 'VATMeshComponent_GetNumAnimations::ReturnValue' has a wrong offset!");
