...
// Package: WBP_RivalSelect_Sub_CharaCutIn
...
// WidgetBlueprintGeneratedClass WBP_RivalSelect_Sub_CharaCutIn.WBP_RivalSelect_Sub_CharaCutIn_C
// 0x0008 (0x0300 - 0x02F8)
class UWBP_RivalSelect_Sub_CharaCutIn_C final : public URivalSelectCharaCutInWidget
{
public:
	class UImage*                                 CharaCutIn;                                        // 0x02F8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
