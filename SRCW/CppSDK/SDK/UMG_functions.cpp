...
// Parameters:
// const int32                             InZOrder                                               (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
bool UUserWidget::ChangeZOrder(const int32 InZOrder)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("UserWidget", "ChangeZOrder");

	Params::UserWidget_ChangeZOrder Parms{};
...
bool UGameViewportSubsystem::ChangeWidgetZOrder(class UWidget* Widget, const int32 InZOrder)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GameViewportSubsystem", "ChangeWidgetZOrder");

	Params::GameViewportSubsystem_ChangeWidgetZOrder Parms{};
