...
// BlueprintGeneratedClass LS_RivalResult_Hvr_L.LS_RivalResult_Hvr_L_DirectorBP_C
// 0x0010 (0x0058 - 0x0048)
class ULS_RivalResult_Hvr_L_DirectorBP_C final : public ULevelSequenceDirector
{
public:
...
public:
	void ExecuteUbergraph_LS_RivalResult_Hvr_L_DirectorBP(int32 EntryPoint);
	void OnCreated();
	void OnPauseScene();
	void OnSlideScreen();
